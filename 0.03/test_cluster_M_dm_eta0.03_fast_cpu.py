...
Purpose
-------
Vectorized CPU implementation of the cluster-only 3% matched-pair CDDR analysis 
using 37 galaxy-cluster angular-diameter distances and matched Pantheon+ SNe Ia. 
...
def load_data():
    ...
    try:
        cov = np.loadtxt("cov_cluster_lens0.03.txt", dtype=np.float64)
    except FileNotFoundError:
...
def main() -> None:
    ...
    cosmo_tools.plot_getdist_advanced(
        ...
        labels,
        stats,
        filename="Cluster_Result_GetDist0.03_fast_cpu.pdf",
    )
